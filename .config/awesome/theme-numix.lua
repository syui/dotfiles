...
theme.ac = pathToConfig .. "/usr/share/icons/Numix/22x22/status/battery-000-charging.svg" 

--{{ For the hard drive icon }} --
theme.hdd = pathToConfig .. "/usr/share/icons/Numix/22x22/devices/gnome-fs-blockdev.svg"
