...
--beautiful.init(awful.util.getdir("config") .. "/themes/powerarrowf/theme.lua")
...
vicious.register(tdwidget, vicious.widgets.date, '<span font="Inconsolata 11" color="#AAAAAA" background="#1F2428"> %b %d %R </span>', 20)
...
'<span background="#313131" font="Inconsolata 11"> <span font="Inconsolata 11" color="#AAAAAA">${/ used_p}/${/ avail_p} GB </span></span>', 800)
...
globalkeys = awful.util.table.join(
 ...
 --awful.key({ }, "Hangul_Hanja", function ()
    --    awful.util.key("Control_L","t") end),
    --awful.util.spawn("tmux send-prefix") end),
    ...
    awful.key({ }, "XF86KbdBrightnessDown", function ()
        awful.util.spawn("kbdlight off") end),
    awful.key({ }, "XF86KbdBrightnessUp", function ()
        awful.util.spawn("kbdlight max") end),
    ...
    --awful.key({ modkey, "Control" }, "n", awful.client.restore),
    -- Applications
    awful.key({ modkey }, "d", function () awful.util.spawn_with_shell('chromium') end),
    awful.key({ modkey }, "t", function () awful.util.spawn_with_shell("spacefm") end),
    awful.key({ modkey }, "n", function () awful.util.spawn_with_shell("nautilus") end),
    ...
    awful.key({ modkey ,"Shift"}, "v", function () awful.util.spawn_with_shell("virtualbox > /dev/null 2>&1 &") end),
    awful.key({ modkey ,"Shift"}, "j", function () awful.util.spawn_with_shell("firefox") end),
    awful.key({ modkey ,"Shift"}, "4", function () awful.util.spawn_with_shell("mkdir -p ~/Pictures/picasa && maim ~/Pictures/picasa/`date +%F-%N`.png") end),
    awful.key({ modkey ,"Shift"}, "5", function () awful.util.spawn_with_shell("maim -s ~/Pictures/picasa/`date +%F-%N`.png") end),
    awful.key({ modkey ,"Shift"}, "6", function () awful.util.spawn_with_shell("maim -i `xdotool getactivewindow` ~/Pictures/picasa/`date +%F-%N`.png") end),
    awful.key({ modkey ,"Shift"}, "7", function () awful.util.spawn_with_shell("gthumb ~/Pictures/picasa/") end),
